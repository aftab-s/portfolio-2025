...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="py-16 lg:py-24 relative overflow-hidden">
      ...
      {/* Gradient blobs */}
      <div 
        className="absolute top-0 left-1/2 -translate-x-1/2 w-[400px] md:w-[600px] lg:w-[800px] h-[200px] md:h-[300px] lg:h-[400px] bg-gradient-to-r from-color-1 to-color-5 rounded-full blur-[60px] opacity-15" 
      />
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="relative p-6 sm:p-8 lg:p-12 xl:p-16 bg-gradient-to-br from-n-7/80 to-n-8/90 border border-n-6/40 rounded-2xl sm:rounded-3xl overflow-hidden mb-12 lg:mb-16"
          >
            {/* Corner accents */}
